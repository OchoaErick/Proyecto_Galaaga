...
#define UE_PROJECT_NAME Proyecto_Galaaga
#define UE_TARGET_NAME Proyecto_GalaagaEditor
#define UE_MODULE_NAME "Proyecto_Galaaga"
...
#define PROYECTO_GALAAGA_API DLLEXPORT
